...
if __name__ == "__main__":
    KNOT_COUNT = 10
#    results = run(DATA_TEST, x=0, y=4, debug=True)

#    results = run(DATA_TEST2, x=0, y=4, debug=True)

#    DIM = 30
#    results = run(DATA_TEST2, x=11, y=15, debug=True)

    DIM = 1000
    results = run(DATA, x=500, y=500, debug=False)
    # 6275 is low
