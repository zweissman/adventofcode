...
if __name__ == "__main__":
    # print("Test1: ", run(part=1, test_suffix="-test", debug=True))  # 11687500
    # print("Real1: ", run(part=1, debug=False))  # 938065580
    # TODO: BROKEN
    # print("Test2: ", run(part=2, test_suffix="-test", debug=True))  #
    print("Real2: ", run(part=2, debug=False))  # 250628960065793
