...
if __name__ == "__main__":
    # print("Test1: ", run(part=1, test_suffix="-test", debug=True))  # 102
    # print("Real1: ", run(part=1, debug=False))  #  916
    # print("Test2: ", run(part=2, test_suffix="-test", debug=True))  # 94
    # TODO: WRONG
    print("Real2: ", run(part=2, debug=False))  # 1064 too low
