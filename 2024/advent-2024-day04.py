...
if __name__ == "__main__":
    # print("Test1: ", run(part=1, test_suffix="-test", debug=True))  # 18
    # print("Real1: ", run(part=1, debug=False))  # 2493
    # print("Test2: ", run(part=2, test_suffix="-test", debug=True))  # 9
    print("Real2: ", run(part=2, debug=False))  # 1890
