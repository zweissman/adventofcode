DATA_TEST1 = ["abcx", "", "abcy", "", "abcz"]
DATA_TEST2 = ["abc", "", "a", "b", "c", "", "ab", "ac", "", "a", "a", "a", "a", "", "b"]
DATA_TEST3 = ["xispjzq", "sqkzcupi", "ikspqyzue"]
DATA = [
    "v",
    "vx",
    "v",
...
def clean_data(data):
    ...
    for row in data:
        if row != "":
            record = (record + " " + "".join(sorted(list(row)))).strip()
        else:
            clean.append(record)
            record = ""
        ...
        for letter in group[min_index]:
            for row in group:
                if letter not in row:
                    # print(f"Can't find {letter} in {row}")
                    #                    break_out = True
                    break
            else:
                group_count += 1
...
if __name__ == "__main__":
    ...
    #    unique_count = get_unique_count(data)
    #    print(f"Unique count: {unique_count}")
    group_count = get_group_count(data)
